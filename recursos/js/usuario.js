...
function regUsuario(){
    ...
    if(formData.get("password")==formData.get("vrPassword")){
        ...
        $.ajax({
           ...
           type:"POST",
           url:"controladorV/usuarioControlador.php?ctrRegUsuario",
           data: formData,
           cache:false,
           contentType:false,
           processData:false,
...
function editUsuario(){
    ...
    if(formData.get("password")==formData.get("vrPassword")){
        ...
        $.ajax({
           ...
           type:"POST",
           url:"controladorV/usuarioControlador.php?ctrEditUsuario",
           data: formData,
           cache:false,
           contentType:false,
           processData:false,
...
Swal.fire({
    ...
    if(result.isConfirmed){
        $.ajax({
            type:"POST",
            url:"controladorV/usuarioControlador.php?ctrEliUsuario",
            data:obj,
            success: function(data) {
              if(data=="ok"){
                location.reload()
